...
const InEditMode = ({ stompblock: { mode } }) => (
  <Dialog open={mode === MODE_EDIT} transition={Transition}>
    <DialogTitle>Unit Now In Edit Mode</DialogTitle>
    <DialogContent>
      <DialogContentText>
        Volume knob will now edit the trim for the last selected note. Hit any trigger on your
        Zendrum to select a note to edit.<br />
        <br />
