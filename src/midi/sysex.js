...
export const SYSEX_MSG_RECEIVED_POLYLOCKS = 0x1a
export const SYSEX_MSG_ADD_POLYLOCK = 0x1b
export const SYSEX_MSG_DELETE_POLYLOCK = 0x1c
export const SYSEX_MSG_SET_MUTE_GROUP_BANK = 0x1d
export const SYSEX_MSG_RECEIVED_POLYLOCKS_ENABLED = 0x1e
export const SYSEX_MSG_SET_POLYLOCKS_ENABLED = 0x1f
export const SYSEX_MSG_STATE_CHANGED = 0x20
export const SYSEX_MSG_GET_STATE = 0x21
